export default function Section7() {
    return (
      <section
        className="bg-gray-900 text-white w-full h-[1226px] text-center flex flex-col items-center justify-centermx-auto relative"
      >
        <div
        ...
        <p className="text-[24px] md:text-[40px] font-bold mb-10 text-gray-50 z-10">XPact</p>
