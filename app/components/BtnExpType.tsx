...
export default function BtnExpType({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`w-[120px] h-11 px-12 py-2.5 gap-[7px] rounded-lg border items-center justify-center inline-flex whitespace-nowrap hover:bg-primary-50 hover:text-gray-900 cursor-pointer
