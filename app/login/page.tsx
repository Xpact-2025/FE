    ...
    return (
        <div className="min-h-screen bg-black text-[#FFFFFF]">            
            ...
            <main className="flex flex-col items-center justify-center py-20 px-4">
                <h1 className="text-[40px] font-bold font-[Pretendard] mb-10">로그인</h1>
                ...
                <div className="mt-[50px] text-[22px] flex justify-between w-full max-w-sm text-sm text-gray-400">
                    <a href="#" className="ml-[10%]">회원가입</a>
                    <a href="#" className="mr-[10%]">비밀번호 찾기</a>
                </div>

                <div className="mt-10 text-center text-gray-400 text-sm">
                    <div className="flex items-center justify-center space-x-4">
                        <hr className="flex-grow border-gray-600 w-[70px]" />
                        <span className="text-[12px] text-gray-400 whitespace-nowrap">SNS 회원가입 및 로그인</span>
                        <hr className="flex-grow border-gray-600 w-[70px]" />
                    </div>
